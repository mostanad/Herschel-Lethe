...
namespace Parameters
{
  ...
  /**
   * @brief Herschel-Bulkley rheological model to solve for non Newtonian
   * flows.
   */
  struct HerschelParameters //Insert by Mo
  {
    // Viscosity of the flow when the shear rate tends to 0
    double viscosity_0;
    // yield stress
    double tauy;
    // Papanastasiou parameter
    double m;
    // Consistency
    double k;
    // Power parameter
